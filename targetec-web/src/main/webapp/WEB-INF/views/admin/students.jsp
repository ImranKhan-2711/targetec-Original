					...
					<div class="box-header">
						<div class="panel-body">
							...
							<div class="filter-invoice">
								<a class="btn btn-success" href="javascript:student('');"> <i
								...
								<c:forEach items="${students.pageItems}" var="student">
									<tr>
										...
										<td width="100px"><a href="javascript:void(0)"
											onclick="javascript:student(${student.id});" class="edit-r">
												<i class="fa fa-pencil" aria-hidden="true"></i>
										</a> <a class="delete-r"
											onClick="javascript:deleteStudent(${student.account.id});">
...
function pageNo(val){
	...
	function student(obj) {
		var url = "/targetec-web/ajax/model/student/edit";
			    ...
			    $.ajax({
			        ...
			        success: function(response){
			        	if(response != ''){
							...
							.ajax({
								type : "GET",
								url : "/targetec-web/ajax/model/student/update",
	...
	function deleteStudent(obj){
		...
		var url = "/targetec-web/ajax/student/delete?${_csrf.parameterName}=${_csrf.token}&id="+id+"&pageNumber="+pageNumber+"";
	    $.ajax({
	        url : url,
	        type : 'GET',
	        success: function(response){
