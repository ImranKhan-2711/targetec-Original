							...
							<div class="row">
								...
								<div class="form-group col-sm-6">
									<div class="pull-right btn_bx">
										<a href="${pageContext.request.contextPath}/admin/testlist" class="btn btn-default">Close</a>
									...
									<c:forEach items="${students.pageItems}" var="student"
										...
										<tr>
											<td><input type="checkbox" value="${st.count-1}"
												id="correctYN-${st.count}" name="correctYN" /> <input
												type="hidden" value="${student.id}" id="studentId"
												name="studentId" /> <input type="hidden"
												value="${student.account.id}" id="accountId"
												name="accountId" /></td>
				...
				<div class="col-sm-7">
					<div class="dataTables_paginate paging_simple_numbers"
						...
						<form role="form" id="pagenumberform" method="post"
							action="${pageContext.request.contextPath}/admin/form/test/student/edit?testId=${test.id}">
							<input type="hidden" name="${_csrf.parameterName}"
