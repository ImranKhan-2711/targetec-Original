		...
		<div class="col-xs-12">
			...
			<div class="box box-primary">
				<ul class="nav nav-tabs">
					...
					<li class="active"><a href="questions?typeId=10000002">Writing</a></li>
					...
					<div class="panel-body">
						<div class="filter-invoice">
							<a class="btn btn-success"
								href="writing/question/form/edit?styleId=10000010&questionId=">
							...
							<tbody>
								<c:forEach items="${questions.pageItems}" var="question">
									<tr>
										...
										<td width="100px"><a
											href="writing/question/form/edit?styleId=${question.styleMaster.id}&questionId=${question.id}"
					...
					<div class="col-sm-7">
						<div class="dataTables_paginate paging_simple_numbers"
							...
							<form role="form" id="pagenumberform" method="post"
								action="${pageContext.request.contextPath}/admin/questions?typeId=10000002">
								<input type="hidden" name="${_csrf.parameterName}"
									value="${_csrf.token}" /> <input type="text" id="pageNumber"
