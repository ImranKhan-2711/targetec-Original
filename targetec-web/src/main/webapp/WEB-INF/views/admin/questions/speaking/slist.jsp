	...
	<ol class="breadcrumb">
		...
		<div class="box box-primary">
				<ul class="nav nav-tabs">
	              ...
	              <li class="active"><a href="questions?typeId=10000004">Speaking</a></li>
	            </ul>
					<div class="box-header  with-border">
						<div class="panel-body">
							<div class="filter-invoice">
								<a class="btn btn-success" href="speaking/question/form/edit?styleId=10000011&questionId="> <i
					...
					<div class="table-responsive">
							...
							<tbody>
								<c:forEach items="${questions.pageItems}" var="question">
									<tr>
										...
										<td width="100px"><a href="speaking/question/form/edit?styleId=${question.styleMaster.id}&questionId=${question.id}"
						...
						<div class="col-sm-7">
							...
							<form role="form" id="pagenumberform" method="post"
										action="${pageContext.request.contextPath}/admin/questions?typeId=10000004">
