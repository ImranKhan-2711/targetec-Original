...
<section class="content-header">
	...
	<div class="box box-primary">
				...
				<div class="form-group  col-md-4 col-lg-4 ">
					<div class="radio">
						<label> <input type="radio" name="styleId" id="styleId2"
							value="10000012" checked="checked"
		...
		<form role="form" id="trainer" method="post"
			action="${pageContext.request.contextPath}/admin/form/test/update?typeId=10000004&styleId=10000012">
			...
			<div class="box-body">
				...
				<div class="row">
					<div class="form-group col-md-12 col-lg-12">
						...
						<div class="form-group col-md-2col-lg-2 picture">
							<img
								...
								type="file" id="wizard-picture" onchange="uploadmedia(this);"
								class="">
						</div>
