...
<section class="content-header">
	...
	<div class="box box-primary">
				...
				<div class="form-group  col-md-4 col-lg-4 ">
					<div class="radio">
						<label> <input type="radio" name="styleId" id="styleId1"
							value="10000006"
							onclick="window.location='/targetec-web/admin/listening/question/form/edit?styleId=10000006&questionId=';">
				...
				<div class="form-group  col-md-4 col-lg-4 ">
					<div class="radio">
						<label> <input type="radio" name="styleId" id="styleId2"
							value="10000009" checked="checked"
							onclick="window.location='/targetec-web/admin/listening/question/form/edit?styleId=10000001&questionId=';">
							Mulitiple Choice
						</label>
					</div>
				</div>
				<div class="form-group  col-md-4 col-lg-4 ">
					<div class="radio">
						<label> <input type="radio" name="styleId" id="styleId3"
							value="10000007"
							onclick="window.location='/targetec-web/admin/listening/question/form/edit?styleId=10000007&questionId=';">
							Write Missing Word
						</label>
					</div>
				</div>
				...
				<div class="form-group  col-md-4 col-lg-4 ">
					<div class="radio">
						<label> <input type="radio" name="styleId" id="styleId4"
							value="10000008"
							onclick="window.location='/targetec-web/admin/listening/question/form/edit?styleId=10000008&questionId=';">
		...
		<form role="form" id="trainer" method="post"
			action="${pageContext.request.contextPath}/admin/form/test/update?typeId=10000003&styleId=10000009">
								...
								<c:forEach items="${question.answers}" var="answers"
									...
									<tr>
										<td><input type="text" class="form-control"
											...
											class="form-control" type="hidden" name="ansdesc"
											value="${answers.description}"> <input type="hidden"
											name="seqNo" id="seqNo" value="${st.count-1}" /></td>
