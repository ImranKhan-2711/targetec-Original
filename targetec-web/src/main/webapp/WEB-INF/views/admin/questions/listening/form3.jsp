...
<section class="content-header">
	...
	<div class="box box-primary">
				...
				<div class="form-group  col-md-4 col-lg-4 ">
					<div class="radio">
						<label> <input type="radio" name="styleId" id="styleId2"
							value="10000009"
							onclick="window.location='/targetec-web/admin/listening/question/form/edit?styleId=10000009&questionId=';">
							Mulitiple Choice
						</label>
					</div>
				</div>
				<div class="form-group  col-md-4 col-lg-4 ">
					<div class="radio">
						<label> <input type="radio" name="styleId" id="styleId3"
							value="10000007" checked="checked"
		...
		<form role="form" id="trainer" method="post"
			action="${pageContext.request.contextPath}/admin/form/test/update?typeId=10000003&styleId=10000007">
				...
				<div class="box">
					<div class="box-body pad">
						...
						<div class="row">
							...
							<div id="loadingimage"
								class="form-group col-md-10 col-lg-10 hide">
								<img
