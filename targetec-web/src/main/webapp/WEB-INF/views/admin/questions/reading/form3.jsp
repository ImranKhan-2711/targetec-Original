...
<section class="content-header">
	...
	<div class="box box-primary">
		...
		<div class="box-header with-border">
			...
			<h3 class="box-title">Add/Edit Re-Order</h3>
			<div class="row">
				...
				<div class="form-group  col-md-4 col-lg-4 ">
					<div class="radio">
						<label> <input type="radio" name="styleId" id="styleId3"
							value="10000003" checked="checked"
		...
		<form role="form" id="trainer" method="post"
			action="${pageContext.request.contextPath}/admin/form/test/update?typeId=10000001&styleId=10000003">
								...
								<c:forEach items="${question.answers}" var="answers"
									...
									<tr>
										<td><input type="text" class="form-control" name="answer"
											id="answer" value="${answers.answer}"
											placeholder="Enter Answer Text" /> <input type="hidden"
											name="answerId" value="${answers.id}" /> <input
											class="form-control" type="hidden" name="ansdesc"
											value="${answers.description}"></td>
										<td><input type="text" name="seqNo" id="seqNo"
											value="${answers.seqNo}" /></td>
									</tr>
								</c:forEach>
							</tbody>
						</table>
