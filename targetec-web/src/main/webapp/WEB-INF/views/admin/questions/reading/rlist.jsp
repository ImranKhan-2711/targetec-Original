		...
		<div class="col-xs-12">
			...
			<div class="box box-primary">
				<ul class="nav nav-tabs">
					<li class="active"><a href="questions?typeId=10000001">Reading</a></li>
					<li class=""><a href="questions?typeId=10000002">Writing</a></li>
					<li class=""><a href="questions?typeId=10000003">Listening</a></li>
					<li class=""><a href="questions?typeId=10000004">Speaking</a></li>
				</ul>
		   <div id="danger" class="alert alert-danger alert-dismissible hide"></div>
				<div id="success" class="alert alert-success alert-dismissible hide"></div>
				<div class="box-header  with-border">
					<div class="panel-body">
						<div class="filter-invoice">
							<a class="btn btn-success"
								href="reading/question/form/edit?styleId=10000001&questionId=">
							...
							<tbody>
								<c:forEach items="${questions.pageItems}" var="question">
									<tr>
										...
										<td width="100px"><a
											href="reading/question/form/edit?styleId=${question.styleMaster.id}&questionId=${question.id}"
											class="edit-r"> <i class="fa fa-pencil"
												aria-hidden="true"></i>
										</a> <a class="delete-r"
											onClick="javascript:deleteReadingQuestion(${question.id});">
					...
					<div class="col-sm-7">
						<div class="dataTables_paginate paging_simple_numbers"
							...
							<form role="form" id="pagenumberform" method="post"
								action="${pageContext.request.contextPath}/admin/questions?typeId=10000001">
...
<script type="text/javascript">
	...
	function deleteReadingQuestion(obj){
		if (confirm('You are proceeding to delete record')) {
		
		var id = obj;
		var pageNumber = $('#pageNumber').val();
	 	var url = "/targetec-web/ajax/question/delete?${_csrf.parameterName}=${_csrf.token}&id="+id+"&pageNumber="+pageNumber+"";
	    $.ajax({
	        url : url,
	        type : 'GET',
