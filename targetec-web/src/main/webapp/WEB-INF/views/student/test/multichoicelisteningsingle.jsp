									...
									<c:forEach items="${question.answers}" var="answer"
										...
										<tr>
											<td><input type="radio" name="radio" id="radio"
												onclick="radioClick(${st.count-1});"></td>
											<td><input id="answers${st.count-1}" name="answers"
												type="hidden" value="${answer.answer}"> <label>${answer.answer}</label>
											</td>
										</tr>
										<tr>
											<td><div class="divider-1 col-lg-12"></div></td>
										</tr>
									</c:forEach>
								</tbody>
							</table>
