			...
			<nav class="navbar navbar-static-top">
				...
				<div class="navbar-custom-menu">
					<ul class="nav navbar-nav">
						<li class="messages-menu"><a href="#"><i
		...
		<aside class="main-sidebar">
			...
			<section class="sidebar">
				...
				<ul class="sidebar-menu">
					...
					<li><a href="${pageContext.request.contextPath}/student/testlist"><i
							class="glyphicon glyphicon-education"></i>My Test</a></li>
					<li><a href="${pageContext.request.contextPath}/student/detaillist"><i
							class="fa fa-area-chart"></i>Detailed Analysis</a></li>
				</ul>
			</section>
			<!-- /.sidebar -->
		</aside>
